 ...
 * @LastEditTime: 2025-12-25 18:12:20
...
2.  **视觉打击感 (Visual Impact)**
    *   **切开效果**: 目前水果是直接消失。优化为**切成两半**并向两侧飞出（使用 Canvas Clip 或预制资源）。
    *   **屏幕震动 (Screen Shake)**: 切中炸弹或高连击时，屏幕轻微震动。
    *   **顿帧 (Hit Stop)**: 切中水果瞬间，画面定格 3-5 帧，增强力量感。
    *   **刀光轨迹**: 优化轨迹渲染，增加发光（Glow）和淡入淡出效果，根据速度改变轨迹粗细。
...
## ✅ 本次行动计划 (Current Session)

我将立即为您执行 **第一阶段** 中最关键的 **“音效系统”** 和 **“屏幕震动”**，这是提升游戏质感最立竿见影的改动。
